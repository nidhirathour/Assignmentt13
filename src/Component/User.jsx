...
console.log(user)
  ...
  return (
   ...
   <div className="mainContainer">
    ...
    <button style={{marginLeft:"25px",backgroundColor:"#00cec9",width:"100px",height:"40px"}} onClick={getUser}>User Data</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <button style={{backgroundColor:"#00cec9",width:"100px",height:"40px"}}  onClick={removeuser}>Remove</button>
    </div>
